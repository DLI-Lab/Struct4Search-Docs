...
`//` 뒤의 내용은 필드 설명이며 실제 JSON 응답에는 포함되지 않습니다.

```json
{
  "unit_id": "ruf_3612bfa54e64f90ad761c4c9", // 답변에서 인용한 원문 청크 ID
  "document_id": "d000786_459d662b8a",         // 원문 청크가 나온 문서의 ID
  "page_number": 1,                             // 원문을 확인할 페이지 번호. 1부터 시작
  "href": "..."                                 // 원본 문서나 해당 페이지를 여는 주소
}
```
